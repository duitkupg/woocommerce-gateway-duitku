 ...
 * QRIS by Nusapay
 *
 * This gateway is used for processing online payment using Nusapay
 *
 * Copyright (c) Duitku
 *
 ...
 *
 * @class       WC_Gateway_Duitku_NUSAPAY_QRIS
 ...
 */
 ...
 class WC_Gateway_Duitku_NUSAPAY_QRIS extends Duitku_Payment_Gateway {
    var $sub_id = 'duitku_nusapay_qris';
        public function __construct() {
	    parent::__construct();
		$this->method_title = 'QRIS by Nusapay';
	    $this->payment_method = 'SQ';
	    //payment gateway logo
	    $this->icon = plugins_url('/assets/duitku_nusapay_qris.png', dirname(__FILE__) );
	...
	function init_form_fields()
	{
			...
			$this->form_fields = array(
			  ...
			  'title' => array(
				...
				'default' => __('Pembayaran Duitku QRIS by Nusapay', 'wc-duitku'),
				'desc_tip'      => true,
			  ),
			  'description' => array(
