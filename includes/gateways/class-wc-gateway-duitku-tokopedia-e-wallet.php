...
/**
 * Duitku Tokopedia E-Wallet
 *
 * This gateway is used for processing online payment using Tokopedia E-Wallet
 *
 * Copyright (c) Duitku
 *
 ...
 *
 * @class       WC_Gateway_Duitku_TOKOPEDIA_E_WALLET
 ...
 */
 ...
 class WC_Gateway_Duitku_TOKOPEDIA_E_WALLET extends Duitku_Payment_Gateway {
    var $sub_id = 'duitku_tokopedia_e_wallet';
        public function __construct() {
	    parent::__construct();
            $this->method_title = 'Duitku Tokopedia E-Wallet';
	    $this->payment_method = 'T2';
	...
	function init_form_fields()
	{
		...
		$this->form_fields = array(
				  ...
				  'title' => array(
					...
					'default' => __('Pembayaran Duitku Tokopedia E-Wallet', 'wc-duitku'),
					'desc_tip'      => true,
				  ),
				  'description' => array(
