 ...
 */
 ...
 class WC_Gateway_Duitku_INDOMARET extends Duitku_Payment_Gateway {
    var $sub_id = 'duitku_indomaret';
        public function __construct() {
	    parent::__construct();
            $this->method_title = 'Duitku Indomaret';
	    $this->payment_method = 'IR';
	    //payment gateway logo
	    $this->icon = plugins_url('/assets/duitku_indomaret.png', dirname(__FILE__) );
	...
	function init_form_fields()
	{
				...
				$this->form_fields = array(
				  ...
				  'title' => array(
					...
					'default' => __('Pembayaran Duitku Indomaret', 'wc-duitku'),
					'desc_tip'      => true,
				  ),
				  'description' => array(
