 ...
 */
 ...
 class WC_Gateway_Duitku_POS extends Duitku_Payment_Gateway {
    var $sub_id = 'duitku_pospay';
        public function __construct() {
	    parent::__construct();
            $this->method_title = 'Duitku PosPay';
	    $this->payment_method = 'A2';
	    //payment gateway logo
	    $this->icon = plugins_url('/assets/duitku_pospay.png', dirname(__FILE__) );
	...
	function init_form_fields()
{
			...
			$this->form_fields = array(
			  ...
			  'title' => array(
				...
				'default' => __('Pembayaran Duitku PosPay', 'wc-duitku'),
				'desc_tip'      => true,
			  ),
			  'description' => array(
