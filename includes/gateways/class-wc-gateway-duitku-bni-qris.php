 ...
 * QRIS by BNI
 *
 * This gateway is used for processing online payment using BNI
 *
 * Copyright (c) Duitku
 *
 ...
 *
 * @class       WC_Gateway_Duitku_BNI_QRIS
 ...
 */
 ...
 class WC_Gateway_Duitku_BNI_QRIS extends Duitku_Payment_Gateway {
    var $sub_id = 'duitku_bni_qris';
        public function __construct() {
	    parent::__construct();
		$this->method_title = 'QRIS by BNI';
	    $this->payment_method = 'IQ';
	    //payment gateway logo
	    $this->icon = plugins_url('/assets/duitku_bni_qris.png', dirname(__FILE__) );
	...
	function init_form_fields()
	{
			...
			$this->form_fields = array(
			  ...
			  'title' => array(
				...
				'default' => __('Pembayaran Duitku QRIS by BNI', 'wc-duitku'),
				'desc_tip'      => true,
			  ),
			  'description' => array(
