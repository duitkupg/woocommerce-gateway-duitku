 ...
 */
 ...
 class WC_Gateway_Duitku_VA_Ritel extends Duitku_Payment_Gateway {
    var $sub_id = 'duitku_va_ritel';
        public function __construct() {
	    parent::__construct();
            $this->method_title = 'Duitku VA Ritel';
	    $this->payment_method = 'FT';
	    //payment gateway logo
	    $this->icon = plugins_url('/assets/duitku_va_ritel.png', dirname(__FILE__) );
	...
	function init_form_fields()
	{
			...
			$this->form_fields = array(
			  ...
			  'title' => array(
				...
				'default' => __('Pembayaran Duitku VA Ritel', 'wc-duitku'),
				'desc_tip'      => true,
			  ),
			  'description' => array(
