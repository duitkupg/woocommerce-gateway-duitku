...
/**
 * Duitku Tokopedia Card Payment
 *
 * This gateway is used for processing online payment using Tokopedia Card payment
 *
 * Copyright (c) Duitku
 *
 ...
 *
 * @class       WC_Gateway_Duitku_TOKOPEDIA_CARD_PAYMENT
 ...
 */
 ...
 class WC_Gateway_Duitku_TOKOPEDIA_CARD_PAYMENT extends Duitku_Payment_Gateway {
    var $sub_id = 'duitku_tokopedia_card_payment';
        public function __construct() {
	    parent::__construct();
            $this->method_title = 'Duitku Tokopedia Card Payment';
	    $this->payment_method = 'T1';
	    //payment gateway logo
	    $this->icon = plugins_url('/assets/duitku_tokopedia.png', dirname(__FILE__) );
	...
	function init_form_fields()
	{
		...
		$this->form_fields = array(
				  ...
				  'title' => array(
					...
					'default' => __('Pembayaran Duitku Tokopedia Card Payment', 'wc-duitku'),
					'desc_tip'      => true,
				  ),
				  'description' => array(
