 ...
 */
 ...
 class WC_Gateway_Duitku_BRIVA extends Duitku_Payment_Gateway {
    var $sub_id = 'duitku_briva';
        public function __construct() {
	    parent::__construct();
            $this->method_title = 'Duitku BRIVA';
	    $this->payment_method = 'BR';
	    //payment gateway logo
	    $this->icon = plugins_url('/assets/duitku_briva.png', dirname(__FILE__) );
	...
	function init_form_fields()
	{
				...
				$this->form_fields = array(
				  ...
				  'title' => array(
					...
					'default' => __('Pembayaran Duitku BRI VA', 'wc-duitku'),
					'desc_tip'      => true,
				  ),
				  'description' => array(
