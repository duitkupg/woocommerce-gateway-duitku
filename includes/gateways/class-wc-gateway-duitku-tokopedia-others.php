...
/**
 * Duitku Tokopedia Others
 *
 * This gateway is used for processing online payment using Tokopedia Others
 *
 * Copyright (c) Duitku
 *
 ...
 *
 * @class       WC_Gateway_Duitku_TOKOPEDIA_OTHERS
 ...
 */
 ...
 class WC_Gateway_Duitku_TOKOPEDIA_OTHERS extends Duitku_Payment_Gateway {
    var $sub_id = 'duitku_tokopedia_others';
        public function __construct() {
	    parent::__construct();
            $this->method_title = 'Duitku Tokopedia Others';
	    $this->payment_method = 'T3';
	...
	function init_form_fields()
	{
		...
		$this->form_fields = array(
				  ...
				  'title' => array(
					...
					'default' => __('Pembayaran Duitku Tokopedia Others', 'wc-duitku'),
					'desc_tip'      => true,
				  ),
				  'description' => array(
