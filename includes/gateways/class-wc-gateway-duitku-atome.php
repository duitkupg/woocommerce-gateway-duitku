 ...
 * Duitku ATOME
 *
 * This gateway is used for processing online payment using ATOME.
 *
 * Copyright (c) Duitku
 *
 ...
 */
 ...
 class WC_Gateway_Duitku_ATOME extends Duitku_Payment_Gateway {
    var $sub_id = 'duitku_atome';
        public function __construct() {
	    parent::__construct();
            $this->method_title = 'Duitku ATOME';
	    $this->payment_method = 'AT';
	    //payment gateway logo
	    $this->icon = plugins_url('/assets/duitku_atome.png', dirname(__FILE__) );
	...
	function init_form_fields()
	{
				...
				$this->form_fields = array(
				  ...
				  'title' => array(
					...
					'default' => __('Pembayaran Duitku Atome', 'wc-duitku'),
					'desc_tip'      => true,
				  ),
				  'description' => array(
